...
export interface ApiMovieReviewMovieReview extends Schema.CollectionType {
  collectionName: 'movie_reviews';
  info: {
    singularName: 'movie-review';
    pluralName: 'movie-reviews';
    displayName: 'Movie Review';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    popularity: Attribute.Float & Attribute.Required;
    budget: Attribute.Integer & Attribute.Required;
    revenue: Attribute.Integer & Attribute.Required;
